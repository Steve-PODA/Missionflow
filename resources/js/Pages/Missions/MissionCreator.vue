...
export default {
  ...
  computed: {
    ...
    timeError() {
      ...
      return this.form.startTime <= new Date().toTimeString().slice(0, 5)
    },
    isValid() {
      return (
        !this.dateError &&
...
.form-card {
  ...
  width: 100%;
  max-width: 800px; /* Plus large et confortable que la modale */
  padding: 40px;
}
...
/* FORM STYLES - Kept identical to component for consistency */
